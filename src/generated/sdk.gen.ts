...
import type { GetHealthData, GetHealthResponse, GetHealthClearCacheData, GetHealthClearCacheResponse, GetHealthClearLogsData, GetHealthClearLogsResponse, PostAuthLoginData, PostAuthLoginResponse, PostAuthRegisterData, PostAuthRegisterResponse, PostAuthExtendTokenData, PostAuthExtendTokenResponse, GetAuthLogoutData, GetAuthLogoutResponse, PostAuthForgotPasswordData, PostAuthForgotPasswordResponse, PostAuthResetPasswordData, PostAuthResetPasswordResponse, GetUsersData, GetUsersResponse, PostUsersData, PostUsersResponse, PostUsersImportData, PostUsersImportResponse, GetUsersExportData, GetUsersExportResponse, DeleteUsersByIdData, DeleteUsersByIdResponse, GetUsersByIdData, GetUsersByIdResponse, PutUsersByIdData, PutUsersByIdResponse, GetUsersEmailByEmailData, GetUsersEmailByEmailResponse, PostUsersFindData, PostUsersFindResponse, DeleteUsersBulkData, DeleteUsersBulkResponse, GetFilesData, GetFilesResponse, DeleteFilesByIdData, DeleteFilesByIdResponse, GetFilesByIdData, GetFilesByIdResponse, PutFilesByIdData, PutFilesByIdResponse, GetFilesUserByUserIdData, GetFilesUserByUserIdResponse, PostFilesFindData, PostFilesFindResponse, PostFilesUploadData, PostFilesUploadResponse, GetConversationsData, GetConversationsResponse, PostConversationsData, PostConversationsResponse, PostConversationsImportData, PostConversationsImportResponse, GetConversationsExportData, GetConversationsExportResponse, DeleteConversationsByIdData, DeleteConversationsByIdResponse, GetConversationsByIdData, GetConversationsByIdResponse, PutConversationsByIdData, PutConversationsByIdResponse, GetConversationsUserByUserIdData, GetConversationsUserByUserIdResponse, PostConversationsFindData, PostConversationsFindResponse, DeleteConversationsBulkData, DeleteConversationsBulkResponse } from './types.gen';
 ...
 */
export const getConversationsUserByUserId = <ThrowOnError extends boolean = false>(options: Options<GetConversationsUserByUserIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetConversationsUserByUserIdResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
