...
import type { GetHealthData, GetHealthResponse, GetHealthClearCacheData, GetHealthClearCacheResponse, GetHealthClearLogsData, GetHealthClearLogsResponse, PostAuthLoginData, PostAuthLoginResponse, PostAuthRegisterData, PostAuthRegisterResponse, PostAuthExtendTokenData, PostAuthExtendTokenResponse, GetAuthLogoutData, GetAuthLogoutResponse, PostAuthForgotPasswordData, PostAuthForgotPasswordResponse, PostAuthResetPasswordData, PostAuthResetPasswordResponse, GetUsersData, GetUsersResponse, PostUsersData, PostUsersResponse, PostUsersImportData, PostUsersImportResponse, GetUsersExportData, GetUsersExportResponse, DeleteUsersByIdData, DeleteUsersByIdResponse, GetUsersByIdData, GetUsersByIdResponse, PutUsersByIdData, PutUsersByIdResponse, GetUsersEmailByEmailData, GetUsersEmailByEmailResponse, PostUsersFindData, PostUsersFindResponse, DeleteUsersBulkData, DeleteUsersBulkResponse, GetFilesData, GetFilesResponse, DeleteFilesByIdData, DeleteFilesByIdResponse, GetFilesByIdData, GetFilesByIdResponse, PutFilesByIdData, PutFilesByIdResponse, GetFilesUserByUserIdData, GetFilesUserByUserIdResponse, PostFilesFindData, PostFilesFindResponse, PostFilesUploadData, PostFilesUploadResponse, GetConversationsData, GetConversationsResponse, PostConversationsData, PostConversationsResponse, PostConversationsImportData, PostConversationsImportResponse, GetConversationsExportData, GetConversationsExportResponse, DeleteConversationsByIdData, DeleteConversationsByIdResponse, GetConversationsByIdData, GetConversationsByIdResponse, PutConversationsByIdData, PutConversationsByIdResponse, GetConversationsEmailByEmailData, GetConversationsEmailByEmailResponse, PostConversationsFindData, PostConversationsFindResponse, DeleteConversationsBulkData, DeleteConversationsBulkResponse } from './types.gen';
...
export const getConversations = <ThrowOnError extends boolean = false>(options?: Options<GetConversationsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetConversationsResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const postConversations = <ThrowOnError extends boolean = false>(options?: Options<PostConversationsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostConversationsResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const postConversationsImport = <ThrowOnError extends boolean = false>(options?: Options<PostConversationsImportData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostConversationsImportResponse, unknown, ThrowOnError>({
        ...formDataBodySerializer,
        security: [
            {
                scheme: 'bearer',
 ...
 */
export const getConversationsExport = <ThrowOnError extends boolean = false>(options?: Options<GetConversationsExportData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetConversationsExportResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const deleteConversationsById = <ThrowOnError extends boolean = false>(options: Options<DeleteConversationsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteConversationsByIdResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getConversationsById = <ThrowOnError extends boolean = false>(options: Options<GetConversationsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetConversationsByIdResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const putConversationsById = <ThrowOnError extends boolean = false>(options: Options<PutConversationsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<PutConversationsByIdResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getConversationsEmailByEmail = <ThrowOnError extends boolean = false>(options: Options<GetConversationsEmailByEmailData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetConversationsEmailByEmailResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
/**
 * Find Conversations by query
 */
export const postConversationsFind = <ThrowOnError extends boolean = false>(options?: Options<PostConversationsFindData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostConversationsFindResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const deleteConversationsBulk = <ThrowOnError extends boolean = false>(options?: Options<DeleteConversationsBulkData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).delete<DeleteConversationsBulkResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
